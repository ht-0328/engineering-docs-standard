...
**この4段階は、この標準が定める要求である。** `SRC-WRITE-003` 3.7 のチェックリストは、おおむね大きい単位から小さい単位へ並んでおり、その並びを根拠にしている。ただし出典の並びは厳密な段階分けではなく、内容の項目が構造の項目の後にも現れる。下の表の「段階」欄は、この標準が付けたものである。
...
**これは気遣いのためではない。** 書き手は、何が伝わったかを知って初めて、次に何を残すべきか判断できる。**削ってはいけない書き方を教えるのが、良い点の指摘である。**
