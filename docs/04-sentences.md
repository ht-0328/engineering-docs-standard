...
## S-16 省略してよいのは、書き手と読者の双方が知っていることだけ

**規範度: 必須**

**なぜ（有用性）**: 短くすることと、情報を落とすことは別である。書き手にとっての常識が、読者の常識とは限らない。
...
**効果**: 長くなったが、読者（IT技術者ではない業務担当者）は「なぜ自分がテストをするのか」が分かる。

**このルールは S-02（50字）と衝突することがある。** 衝突したら、**このルールが勝つ。** 短さより正確さが優先される。
